  ...
  const carregarLojas = async () => {
    try {
      ...
      if (data && data.length > 0) {
        setFormData((prev) => ({ ...prev, loja_id: data[0].id.toString() }));
      }
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (foto) {
        ...
        if (!foto_url) return; // Erro no upload
      }
      ...
      setErrors((prev) => ({ ...prev, submit: "Erro ao criar vendedor" }));
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Novo Vendedor</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Campo opcional - descreva a área de especialidade do vendedor
                </p>
              </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-gray-900">
                  {formData.nome || "Nome do Vendedor"}
                </h3>
