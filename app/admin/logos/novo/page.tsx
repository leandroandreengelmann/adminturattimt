...
export default function NovoLogoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Erro ao criar logo. Tente novamente.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Novo Logo</h1>
            <p className="text-lg text-gray-600">
              Adicione um novo logo para o cabeçalho ou rodapé
            </p>
          </div>
        </div>
