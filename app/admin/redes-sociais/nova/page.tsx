...
export default function NovaRedeSocialPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.from("redes_sociais").insert([formData]);
      ...
      setErrors((prev) => ({ ...prev, submit: "Erro ao criar rede social" }));
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mt-1">
              Adicione uma nova rede social ao site
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Ordem em que a rede social aparecerá no site (0 = primeiro)
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Apenas redes sociais ativas aparecem no site
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">
                    {formData.nome || "Nome da Rede Social"}
                  </h3>
          ...
          <div className="flex justify-end gap-4">
            ...
            >
              {loading ? "Salvando..." : "Salvar Rede Social"}
            </button>
          </div>
