...
export default function EditarBannerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors((prev) => ({ ...prev, submit: "Erro ao atualizar banner" }));
    } finally {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setErrors((prev) => ({ ...prev, submit: "Erro ao excluir banner" }));
    } finally {
      setSaveLoading(false);
    }
  };
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
              ...
              <div>
                ...
                {new Date(banner.updated_at).toLocaleString("pt-BR")}
              </div>
              <div>
              ...
              <div>
                <span className="font-medium">Ordem:</span> {banner.ordem}
              </div>
            </div>
          </div>
